        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Game Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Game name"),
                    GenreId = table.Column<int>(type: "int", nullable: false, comment: "Genre Identifier"),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Game image url"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, comment: "Game price"),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Game description")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "User Identifier"),
                    GameId = table.Column<int>(type: "int", nullable: false, comment: "Game Identifier"),
                    Quantity = table.Column<int>(type: "int", nullable: false, comment: "Bought games quantity")
                },
                constraints: table =>
                {
