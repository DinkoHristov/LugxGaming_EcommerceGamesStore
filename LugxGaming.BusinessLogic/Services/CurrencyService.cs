...
namespace LugxGaming.BusinessLogic.Services
{
    ...
    {
        private readonly string COINGECKO_API = "CG-JsfSfQx5ECvfxvsy1sYMNL7e";
        ...
        private async Task<decimal> FetchEthPriceFromApi()
        {
            try
            {
                ...
                var response = await client.GetStringAsync($"https://api.coingecko.com/api/v3/simple/price?ids=ethereum&vs_currencies=usd&x_cg_demo_api_key={COINGECKO_API}");
